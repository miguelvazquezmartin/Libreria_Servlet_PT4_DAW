		...
		<div class="text-center">
			<table class="table table-striped "> 
				<thead>
			      <tr class="table-dark">
			      	<td>ID</td>
			      	<td class="text-end">Editorial</td>      
			      </tr>             
			   	</thead>
		        <tbody>
		         	<%
					    ...
					    {
					        out.println("<tr>");
					        out.println(" <td>" + modeloEditorial.getIdEditorial(i) + "<td>");
							out.println(" <td>" + modeloEditorial.getNombreEditorial(i) + "<td>");
							out.println("</tr>");		
						} 
					%>      
			...
			<div class="row text-center">
				<div class="col-12 py-5">
					<form name="volver" action="shopping" method="POST">     
						<input type="hidden" name="crud" value="volverEditorial">     
