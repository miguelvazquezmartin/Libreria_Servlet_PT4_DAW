			...
			<div class="row">
				<form name="dropLibro" action="shopping" method = "POST"> 
				  	<div class="col-12 text-center mb-3">
					  	<h3>Elige el libro que quieres borrar</h3>
				  	</div>
				  	<div class="col-12 text-center mb-3">
					  	<label for="stock">Libro:</label>
					...
					<%
	     			...
	     			%>    
				  	...
				  	<div class="col-12 text-center mb-3">
				  		<input type="hidden" name="drop" value="dropBook"> 
					  	<input type="submit" value="Borrar libro" class="bg-success border border-0"> 
				  	</div>
				</form>
			</div>
		</div>
		<div class="container-fluid">
			<div class="row">
				<div class="col-12 text-center"> 
					<form name="volverLibro" action="shopping" method = "POST">
					  	<input type="hidden" name="drop" value="volverBaja"> 
